...
def Marchenko_depthloop(zinvs,zendvs):
    ...
    for iz in range(nvsz):
        ...
        for ix in range(nvsx):
            ...
            f1_1_minus, f1_1_plus, f1_2_minus, f1_2_plus, g_1_minus, g_1_plus, g_2_minus, g_2_plus = MF.machenkoFocSourceLoop_JointLsqr(direct,toff,g0VS,iava1,Rop1,R1op1,Restrop1,iava2,Rop2,R1op2,Restrop2,t)
    ...
    return PUP1, PDOWN1, PUP2, PDOWN2, redatumed1, redatumed2

if __name__ == "__main__":
    a = int(sys.argv[1])
    b = int(sys.argv[2])
    Marchenko_depthloop(a, b)
