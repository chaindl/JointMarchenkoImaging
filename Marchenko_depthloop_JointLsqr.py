...
from pylops.basicoperators import Restriction, Diagonal, BlockDiag, VStack, HStack, Zero
...
def Marchenko_depthloop_JointLsqr(zinvs,zendvs):
    ...
    for iz in range(nvsz):
        ...
        for ix in range(nvsx):
            ...
            # Marchenko focusing
            f1_1_minus, f1_1_plus, f1_2_minus, f1_2_plus, g_1_minus, g_1_plus, g_2_minus, g_2_plus = focusing_wrapper(direct,toff,g0VS,iava1,Rop1,R1op1,Restrop1,iava2,Rop2,R1op2,Restrop2,t)
...
def focusing_wrapper(direct,toff,g0VS,iava1,Rop1,R1op1,Restrop1,iava2,Rop2,R1op2,Restrop2,t):
    nsmooth=10
    nr=direct.shape[0]
...
if __name__ == "__main__":
    a = int(sys.argv[1])
    b = int(sys.argv[2])
    Marchenko_depthloop_JointLsqr(a, b)
